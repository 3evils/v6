...
( U | - | 2 | 3 | 2 )-( S | o | u | r | c | e )-( C | o | d | e )
 \_/ \_/ \_/ \_/ \_/   \_/ \_/ \_/ \_/ \_/ \_/   \_/ \_/ \_/ \_/
 */
//== Error reporting... Turn off = 0 when running live
$INSTALLER09['error_reports']['debugmode'] = 1;
//== Error reporting check begins
...
define('TRACKER_SECRET', 'FZKU2wWVpqcWqvMXo4lLJYgwR2Dah4UI');
define('TRACKER_REPORTKEY', 'FZKU2wWVpqcWqvMXo4lLJYgwR2Dah4UI');
define('TRACKER_HOST', '51.77.32.34');
define('TRACKER_PORT', 34000);
define('OCELOT_CONF', '/var/www/trinity/ocelot.conf');
//==charset
...
$INSTALLER09['cookie_domain'] = '.3evils.com'; // set to eg: .somedomain.com or is subdomain set to: .sub.somedomain.com
//== Memcache expires
$INSTALLER09['expires']['latestuser'] = 0; // 0 = infinite
$INSTALLER09['expires']['MyPeers_'] = 120; // 120 = 2 min
...
$INSTALLER09['expires']['poll_data'] = 900; // 900 = 15 min
...
$INSTALLER09['expires']['activeusers'] = 60; // 60 = 1 min
$INSTALLER09['expires']['forum_users'] = 30; // 30 = 30 seconds
$INSTALLER09['expires']['section_view'] = 30; // 30 = 30 seconds
$INSTALLER09['expires']['child_boards'] = 900; // 60 = 1 min
$INSTALLER09['expires']['sv_child_boards'] = 900; // 900 = 15 min
$INSTALLER09['expires']['forum_insertJumpTo'] = 3600; // = 1 hour
$INSTALLER09['expires']['last_post'] = 0; // 0 = infinite
$INSTALLER09['expires']['sv_last_post'] = 0; // 0 = infinite
$INSTALLER09['expires']['last_read_post'] = 0; // 0 = infinite
$INSTALLER09['expires']['sv_last_read_post'] = 0; // 0 = infinite
...
$INSTALLER09['expires']['movieofweek'] = 300; // 300 = 5 min
...
$INSTALLER09['expires']['latest_news_tpl'] = 30; // 0 = infinite
$INSTALLER09['expires']['latesttorrents_tpl'] = 30;  // 0 = infinite
$INSTALLER09['expires']['latestposts_tpl'] = 30;  // 0 = infinite
...
//== Tracker configs
$INSTALLER09['passhhash']['salting'] = 'This@is9just[[a=stupid^^text)to(salt--the""cookies;-)';
...
$INSTALLER09['mods']['snow'] = true;
$INSTALLER09['votes_required'] = 2;
$INSTALLER09['catsperrow'] = 5;
$INSTALLER09['maxwidth'] = '85%';
$INSTALLER09['torrent']['free_target'] = 2500;
$INSTALLER09['torrent']['freepoll_points'] = 2500;
$INSTALLER09['design'] = 1;
//== Latest posts limit
...
define('TMDB_DIR', ROOT_DIR . 'tmdb' . DIRECTORY_SEPARATOR);
define('DESIGN_DIR', ROOT_DIR . 'design' . DIRECTORY_SEPARATOR);
...
//$INSTALLER09['tpl_path'] = 'tpl_templates/';
//$INSTALLER09['tpl_delimiters'] = '{#%s#}';
//$INSTALLER09['tpl_cache_time'] = 30;
//== PHP or Ocelot announce
if (OCELOT_TRACKER == true) {
$INSTALLER09['ocelot_prefix'] = 'http://tracker.3evils.com:'.TRACKER_PORT.'/';  
$INSTALLER09['ocelot_suffix'] = '/announce';
$INSTALLER09['announce_urls'][] = 'http://tracker.3evils.com:'.TRACKER_PORT.'/announce';
} else {
$INSTALLER09['announce_urls'] = array();
$INSTALLER09['announce_urls'][] = 'http://3evils.com/announce.php"';
$INSTALLER09['announce_urls'][] = 'https://3evils.com/announce.php"';
}
...
$INSTALLER09['site_email'] = 'webmail';
$INSTALLER09['site_name'] = '3 Evils';
...
$INSTALLER09['expiry']['trialdelete'] = 7 * 86400; // 7 days until the account will be deleted from the database
...
$INSTALLER09['tv_cats'] = array(
    5);
$youtube_pattern = "/^http(s)?\:\/\/www\.youtube\.com\/watch\?v\=[\w-_]{11}/i";
...
$INSTALLER09['bucket_maxsize'] = 1024 * 1024; //max size set to 500kb
//==Class check by pdq
...
$INSTALLER09['staff']['forumid'] = 6; // this forum ID should exist and be a staff forum

...
<body>";
    ...
    $usrclass2 = "";
    if ($CURUSER['override_class'] != 255) $usrclass2 = "&nbsp;<b>" . get_user_class_name($CURUSER['class']) . "</b>&nbsp;";
    else if ($CURUSER['class'] >= UC_STAFF) $usrclass2 = "&nbsp;<a href='./setclass.php'><b>" . get_user_class_name($CURUSER['class']) . "</b></a>&nbsp;";
if ($CURUSER) {
	$htmlout .="<div data-sticky-container>
		<div data-sticky data-options='marginTop:0;'>
			<div class='title-bar' data-top-anchor='1'>
				<div class='title-bar-left' style='width:60%;'>
					<button class='menu-icon' type='button' data-open='offCanvasLeftNav'></button>
					<a class='menu-text' href='" . $INSTALLER09['baseurl'] . "/index.php'>Home</a>
				
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				".format_username($CURUSER)."<span style='color:white;'>[".$usrclass2."]</span>&nbsp;<b><font color='#fff'>Invites</font></b>&nbsp;<a href='./invite.php'><b><font color='#0085C2'>{$CURUSER['invites']}</font></b></a>&nbsp;&nbsp;<b><font color='#fff'>Bonus</font></b>&nbsp;<a href='./mybonus.php'><b><font color='#0085C2'>{$CURUSER['seedbonus']}</font></b></a><b><font color='#fff'>&nbsp;Ratio</font></b>&nbsp;<b><span color='#0085C2'>".member_ratio($CURUSER['uploaded'], $CURUSER['downloaded'])."</span></b>"."&nbsp;<b><font color='#fff'>Up&nbsp;</font></b><b><font color='#0085C2'>".mksize($CURUSER['uploaded'])."</font></b>"."&nbsp;<b><font color='#fff'>Down&nbsp;</font></b><b><font color='#ff0000'>".mksize($CURUSER['downloaded'])."</font></b>
				
				</div>
				<div class='title-bar-right' style='max-width:30%;'>
				<a class='small label' href='" . $INSTALLER09['baseurl'] . "/browse.php'>Torrents</a>
				<a class='small label' href='" . $INSTALLER09['baseurl'] . "/lottery.php'>Lottery</a>
				<a class='small label' href='" . $INSTALLER09['baseurl'] . "/casino.php'>Casino</a>
	...
	$htmlout .= "<div class='off-canvas position-left' id='offCanvasLeftNav' data-off-canvas>
		<ul class='menu vertical'>
			<a class='button small' style='background-color: #148ec585!important;' href='#'>{$lang['gl_general']}</a>
			...
			<a class='success button' style='background-color: #148ec585!important;' href='#'>{$lang['gl_games']}</a>	
			...
			<a class='button small' style='background-color: #148ec585!important;' href='#'>{$lang['gl_torrent']}</a>
			...
			<a class='success button' style='background-color: #148ec585!important;' href='" . $INSTALLER09['baseurl'] . "/donate.php'>{$lang['gl_donate']}</a>
			<a class='button small' style='background-color: #148ec585!important;' href='" . $INSTALLER09['baseurl'] . "/forums.php'>{$lang['gl_forums']}</a>
			<a class='button small' style='background-color: #148ec585!important;'  href='#'>Staff Tools</a>	
			...
			<a class='button primary' style='background-color: #148ec585!important;'  href='#'>Pers Tools</a>
			...
			<li><a class='menu-text button small alert' style='background-color:#90191980!important;' href='" . $INSTALLER09['baseurl'] . "/logout.php?hash_please={$salty}'>{$lang['gl_logout']}</a></li>
		</ul>
	</div>";
	$htmlout .= "<div class='off-canvas position-right' id='offCanvasRightNav' data-off-canvas data-transition='push'>";
		if (curuser::$blocks['global_stdhead'] & block_stdhead::STDHEAD_STAFFTOOLS && $BLOCKS['global_staff_tools_on'] && $CURUSER['class'] >= UC_STAFF) {
			require_once ('./design/1/blocks/global/staff_tools.php');
		}
	$htmlout .="</div>
";
...
<div style='width:100%;margin-bottom:30px;' class='large-6 columns'>
	<img style='margin-left:auto;margin-right:auto;display:block;margin-bottom:-2%;margin-top:-8%;max-width:75%' src='templates/1/pic/banners/chrome.png' class='banner'>
";
}
if ($CURUSER) {
	$htmlout .="
    ...
    <div class='row'>";
		...
		$htmlout .='<div class="small2 button-group">';
 ...
 function stdfoot($stdfoot = false)
{
    ...
    <script type="text/javascript" src="arrowchat/modarrowchat/modembed/js/modembed.js"></script>';    //== query stats
    $htmlfoot.= '';
    if (!empty($stdfoot['js'])) {
...
function StatusBar2()
{
    global $CURUSER, $INSTALLER09, $lang, $rep_is_on, $mc1, $msgalert;
    if (!$CURUSER) return "";
    $up = mksize($CURUSER['uploaded']);
    $down = mksize($CURUSER['downloaded']);
    //==Memcache unread pms
    $PMCount = 0;
    ...
    if (!empty($seed['conn'])) {
        switch ($seed['conn']) {
            ...
            case 2:
                $connectable = "<b><font color='#00be00'>YES</font></b>";
                break;
    ...
    $StatusBar2 =
        "<div id='statusbar'>".
        "<div style='color:white;margin-top:2px;'>{$lang['gl_msg_welcome']},
			".format_username($CURUSER)."&nbsp;&nbsp;<font color='#fff'><b>Time Is</b></font>&nbsp;<span id='clock'><b><font color='#00ffff'>{$clock}</font></b></span>&nbsp;
			<b><font color='#fff'>Invites</font></b>&nbsp;<a href='./invite.php'><b><font color='#0085C2'>{$CURUSER['invites']}</font></b></a>&nbsp;&nbsp;<b><font color='#fff'>Bonus</font></b>&nbsp;<a href='./mybonus.php'><b><font color='#0085C2'>{$CURUSER['seedbonus']}</font></b></a> 
		&nbsp;<b><font color='#fff'>Ratio</font></b>&nbsp;<b><span color='#0085C2'>".member_ratio($CURUSER['uploaded'], $CURUSER['downloaded'])."</span></b>".
        "&nbsp;&nbsp;<b><font color='#fff'>Up</font></b>&nbsp;<b><font color='#0085C2'>$upped</font></b>".
        "&nbsp;&nbsp;<b><font color='#fff'>Down</font></b>&nbsp;<b><font color='#ff0000'>$downed</font></b>".
        "&nbsp;&nbsp;<b><font color='#fff'>Rep</b>&nbsp;<b>$member_reputation</b>&nbsp;</p></div>".
        "<div><p style='text-align:right;'>".
        "&nbsp;&nbsp; </a></p></div>".
        "</div>";

    $StatusBar2 .='<script type="text/javascript">
    function refrClock(){
    var d=new Date();
    var s=d.getSeconds();
    var m=d.getMinutes();

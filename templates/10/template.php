...
<!DOCTYPE html>
  ...
  <head>
	...
	<link rel="stylesheet" href="templates/' . $stylez . '/10.css" />
	<!-- Global CSS-->
	...
	<script src="templates/10/js/vendor/jquery.js"></script>
...
<div style='width:100%;margin-bottom:30px;' class='large-6 columns'>
	<img style='margin-left:auto;margin-right:auto;display:block;margin-top:-6%;max-width:75%' src='templates/10/pic/banners/red.png' class='banner'>
";
}
if ($CURUSER) {
	$htmlout .="

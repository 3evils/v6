<?php
	...
	*/
	...
	$application_name 	= "3 Evils Dragon Radio";
	...
	$folder_location	= "streaming_radio3";
	...
	// OPTIONAL
	// Update link for the application.
	$update_link		= "http://www.arrowchat.com/updatecheck.php?id=32";

...
<head> 
	...
	<script type="text/javascript" src="<?php echo $base_url; ?>public/popout/js/modmentions.js"></script>
	<script type="text/javascript" src="arrowchat/modarrowchat/modembed/js/modembed.js"></script>

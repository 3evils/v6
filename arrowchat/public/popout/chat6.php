...
#arrowchat_popout_container {
    ...
    display: block;
    zoom: 1;
    border-bottom: 1px solid #24c20b;
}
...
.arrowchat_smiley_button {
    ...
    z-index: 1091;
		...
		.arrowchat_chatroom_room_list{
			...
			line-height:100%;
			color: #fff;
			border-top:1px solid #c0d35b;
			border-bottom:1px solid #c0d35b;
...
.arrowchat_chatroom_list_title{color: #c0d35b;font-size:13px;line-height:24px;padding:0 12px}
...
.arrowchat_self .arrowchat_chatboxmessage_wrapper{background-color:transparent !important;color:#fff !important;margin-left:35px;float:right}
...
.arrowchat_self .arrowchat_chatroom_message_content{background-color: #c0d35b;color:#fff;margin-left:35px;float:right}
...
::-webkit-scrollbar-thumb:horizontal {
  border-top: 1px solid #ECFF67;
  border-bottom: 1px solid #ECFF67;
  border-radius: .3125em;
...
::-webkit-scrollbar-thumb:vertical {
  border-left: 1px solid #ECFF67;
  border-right: 1px solid #ECFF67;
  border-radius: .625em;

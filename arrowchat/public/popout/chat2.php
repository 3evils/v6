...
<head>
	...
	<link type="text/css" rel="stylesheet" media="all" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.9.0/css/all.css" charset="utf-8" />
    ...
    <link href="https://fonts.googleapis.com/css?family=Changa|Handlee|Passion+One:400,700&display=swap" rel="stylesheet">
...
#arrowchat_popout_container {
    ...
    display: block;
    zoom: 1;
    border-bottom: 1px solid #56a8e3;
}
...
.arrowchat_popout_focused {
	...
	.others{font-family:'Cabin Condensed', sans-serif;
    font-weight:normal;
        ...
        .spd2{font-family:'Cabin Condensed', sans-serif;
            font-weight:normal;
            font-size:10px!important;
            position: absolute!important;
            margin-left: 40px!important;
...
.arrowchat_chatroom_list_title{color:#0085C2;font-size:13px;line-height:24px;padding:0 12px}
...
.arrowchat_self .arrowchat_chatboxmessage_wrapper{background-color:transparent !important;color: #44f700ab !important;margin-left:35px;float:left;
   /* font-weight: bold;*/
    font-family: 'Changa', sans-serif;}

        .arrowchat_popout_room_msg .arrowchat_chatroom_message_name {
            top: 5px;
            padding-left: 4px;
        ...
        .arrowchat_popout_convo .arrowchat_chatboxmessagecontent {
            font-size: 16px;
        }
...
.arrowchat_self .arrowchat_chatroom_message_content{font-weight:bold!important;background-color:#4080ff;color:#fff;margin-left:35px;float:right}

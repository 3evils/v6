...
?>
                    ...
                    <div class="subExplain">
						<i>This page checks for the latest version of ArrowChat.  If you need to update, please follow the instructions posted in our <a href="https://www.arrowchat.com/forum/viewforum.php?f=4" style="font-size:14px" target="_blank">release notes</a>.</i>
                    </div>
					<fieldset>
						<dl class="selectionBox">
							...
							<dd>
								<p class="explain" style="font-size:13px; margin-top: 7px;">
					...
					<fieldset>
						...
						<!-- <dl class="selectionBox">
							...
							<dd>
								...
								<p class="explain">
									Checking this will enable SSL on the push server. <strong>WARNING: SSL messages count as 2 messages, only turn on if necessary.</strong>
								</p>
							</dd>
						</dl> -->
						<dl class="selectionBox">
				...
				?>
					...
					<?php if(empty($_SESSION['counter'])) { ?>
						<p style="margin: 25px 0 15px">
							<img src="./images/img-check.png" alt="Done" width="98" height="128" />
						</p>
...
<?php
			...
			{
?>
								<a href="javascript:void(0);" class="secondaryContent">Currently Activated</a>
<?php
			} 
			else 
			{
?>
								<a href="system.php?do=language&activate=<?php echo $folder['name']; ?>" class="secondaryContent">Activate</a>
<?php
			}
?>
								<h4>

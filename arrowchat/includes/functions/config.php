...
$INSTALLER09['happy_hour'] = true; //== Off for XBT
$INSTALLER09['rep_sys_on'] = true;
$INSTALLER09['achieve_sys_on'] = true;
$INSTALLER09['mood_sys_on'] = true;
$INSTALLER09['mods']['slots'] = false;
$INSTALLER09['votesrequired'] = 15;
$INSTALLER09['catsperrow'] = 6;
$INSTALLER09['maxwidth'] = '95%';
//== Latest posts limit
...
//== XBT or PHP announce
if (XBT_TRACKER == true) {
$INSTALLER09['xbt_prefix'] = 'https://www.3evils.com/announce.php:2710/';  
$INSTALLER09['xbt_suffix'] = '/announce';
$INSTALLER09['announce_urls'][] = 'https://www.3evils.com/announce.php:2710/announce';
} else {
$INSTALLER09['announce_urls'] = array();
$INSTALLER09['announce_urls'][] = 'https://www.3evils.com/announce.php';
$INSTALLER09['announce_urls'][] = 'https://www.3evils.com/announce.php';
}
$INSTALLER09['baseurl'] = 'http://www.3evils.com';
...
$INSTALLER09['site_email'] = 'antimidas@3evils.com';
...
// This is added for sub categories :
$INSTALLER09['expires']['genrelist2'] = 30*86400; // 30x86400 = 30 days
$INSTALLER09['catperrow'] = 5;  // There will always only be 5 Main Categories !
$INSTALLER09['subcatperrow'] = 5;
// End add
...
$INSTALLER09['variant'] = 'U-232 V5 Evil Edit';

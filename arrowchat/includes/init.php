<?php
	...
	*/
	...
	{
		$result = $db->execute("
			SELECT theme, status, popout, hash_id, hide_bar, is_admin, play_sound, window_open, chatroom_window, chatroom_stay, chatroom_block_chats, unfocus_chat, focus_chat, apps_bookmarks, apps_other, block_chats, chatroom_sound, apps_open, guest_name, chatroom_show_names, ip_address, is_mod, chatroom_unfocus
		...
		//	}
			...
			if (!empty($row['chatroom_unfocus'])) 
			{
				$chatroom_unfocus = unserialize($row['chatroom_unfocus']);
			}

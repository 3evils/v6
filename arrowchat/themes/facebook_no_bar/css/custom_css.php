.arrowchat_bar_button,#arrowchat_buddy_list_tab,.arrowchat_apps_button,.arrowchat_tray_button,#arrowchat_show_bar_button,#arrowchat_chatbox_left{-webkit-box-shadow:none;background:#<?php echo $bar_background; ?>;color:#<?php echo $bar_text; ?>;border-top:1px solid #<?php echo $bar_border; ?>}
...
.arrowchat_tabmouseover,.arrowchat_chatbox_lr_mouseover{background-color:#<?php echo $bar_hover; ?> !important}
#arrowchat_base{border-right:1px solid #<?php echo $bar_border; ?>;border-left:1px solid #<?php echo $bar_border; ?>;border-bottom: 0}
...
.arrowchat_typing_title,.arrowchat_userstabtitle,.arrowchat_moderation_title,.arrowchat_traytitle,.arrowchat_unseen_title{background-color:#<?php echo $window_title_focus; ?> !important}
.arrowchat_tabtitle,.arrowchat_chatrooms_title{background-color:#<?php echo $window_title; ?>}
.arrowchat_chatroom_lobby_title{background-color:#<?php echo $window_title_focus; ?> !important}
...
.arrowchat_unseen_close_hover{background-color:#<?php echo $window_title_hover; ?>;color:#<?php echo $window_text; ?>}
...
.arrowchat_tabpopup,#arrowchat_unseen_users,.arrowchat_apppopup{-webkit-box-shadow:0 1px 1px #<?php echo $bar_border; ?>;-moz-box-shadow:0 1px 1px #<?php echo $bar_border; ?>;box-shadow:0 1px 1px #<?php echo $bar_border; ?>}

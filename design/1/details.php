...
$HTMLOUT .= "<li class='tabs-title'><a href='#tab_e' data-tabs-target='tab_e'>YouTube and Omdb</a></li>
</ul>";
...
if (empty($tvmaze_info) && empty($omdb) && in_array($torrents['category'], array_merge($INSTALLER09['movie_cats'], $INSTALLER09['tv_cats']))) $HTMLOUT.= "<tr><td colspan='2'>No Omdb or TVMaze info.</td></tr>";
$HTMLOUT.= "</table>

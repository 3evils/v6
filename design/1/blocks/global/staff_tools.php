...
//==Staff tools quick link - Stoner
 ...
 $mc1->cache_value('is_staff_' . $CURUSER['class'], $mysql_data, $INSTALLER09['expires']['staff_check']);
  ...
  if ($mysql_data) { 
   $htmlout .= '
   <a href="#" style=\'background-color: #148ec585!important;\' class="button small">User</a>';
  ...
  $htmlout .= '
   <a href="#" style=\'background-color: #148ec585!important;\' class="button small">Settings</a>';
  ...
  $htmlout .= '
<a href="#" style=\'background-color: #148ec585!important;\' class="button small">Stats</a>';
  ...
  $htmlout .= '
<a href="#" style=\'background-color: #148ec585!important;\' class="button small">Other</a>';

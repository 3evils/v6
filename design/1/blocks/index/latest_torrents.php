...
$HTMLOUT.="<div class='card'>
	<div class='card-divider portlet-header'>{$lang['index_latest']}</div>
    ...
    $HTMLOUT.= "<div class='module'><div class='tbadge tbadge-top'></div>
            ...
            <thead>
				<tr>
					...
					<th><b>{$lang['top5torrents_name']}</b></th>
					<th>{$lang['top5torrents_seeders']}</th>
					<th>{$lang['top5torrents_leechers']}</th>
					<th>{$lang['top5torrents_health']}</th>
				</tr>
			</thead>";
if ($top5torrents) {
        ...
        if (empty($top5torrents)) $HTMLOUT.= "<tbody><tr><td>{$lang['top5torrents_no_torrents']}</td></tr></tbody>";
    }
	$HTMLOUT.= "</table></div>";
}
//==Last 5 begin
...
<td class='text-center'><span class='badge'>$thealth</td>             
        ...
        //== If there are no torrents
        if (empty($last5torrents)) $HTMLOUT.= "<tbody><tr><td class='text-left' colspan='3'>{$lang['last5torrents_no_torrents']}</td></tr></tbody>";
    }
	        $HTMLOUT.= "</table></div>";
}*/
$HTMLOUT.="</div></div>";
